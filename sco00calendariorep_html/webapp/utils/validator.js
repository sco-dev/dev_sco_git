...
sap.ui.define([
    ...
    Validator.prototype._validate = function (oControl) {
        var aPossibleAggregations = [ "items", "content", "form", "formContainers", "formElements", "fields", "sections", "subSections", "_grid", "subHeader", "cells", "rows"],
        ...
        if (oControl instanceof sap.ui.core.Control ||
            ...
            if ((oControl instanceof sap.ui.table.Row && !oControl._bHidden) || oControl.getVisible()) {
