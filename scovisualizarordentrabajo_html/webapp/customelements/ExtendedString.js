...
sap.ui.define([
    ...
    return String.extend("sapui5agendar.scovisualizarordentrabajo_html.customelements.ExtendedString", {
                    ...
                    switch (sName) {
                        ...
                        case "type":
                            switch (oContent) {
                                ...
                                case "optionalInt":
                                case "int":
                                    if ((oContent != 'optionalInt' || (oContent == 'optionalInt' && value)) && (parseInt(value).toString() !== value.replace(/^0+/,""))) {
                                        aViolatedConstraints.push('type');
