...
function (jQuery, Control, LocaleData, Date1, CalendarUtils, Header, Month, MonthPicker, YearPicker, CalendarDate, library) {
     ...
     */
    var MonthCalendar = Control.extend("sapui5agendar.scovisualizarordentrabajo_html.customelements.monthpicker.MonthCalendar", /** @lends sap.ui.unified.MonthCalendar.prototype */ { metadata : {
    ...
    MonthCalendar.prototype.init = function(){
        ...
        this._iMode = 1; // months are shown
        ...
        oMonthPicker.setMonth(today.getMonth());
        ...
        oYearPicker.setYear(today.getFullYear());
    ...
    MonthCalendar.prototype.exit = function(){
    ...
    MonthCalendar.prototype._createMonth = function(sId){
    ...
    MonthCalendar.prototype.onBeforeRendering = function(){
    ...
    MonthCalendar.prototype.onAfterRendering = function(oEvent){
        ...
        this.$("contentOver").css("background-color", "#fff");
        this.$("contentOver").css("opacity", "1");
        _showMonthPicker.call(this);

    };

    // overwrite invalidate to recognize changes on selectedDates
    MonthCalendar.prototype.invalidate = function(oOrigin) {
    ...
    MonthCalendar.prototype.removeAllSelectedDates = function() {
    ...
    MonthCalendar.prototype.destroySelectedDates = function() {
    ...
    MonthCalendar.prototype.removeAllSpecialDates = function() {
    ...
    MonthCalendar.prototype.destroySpecialDates = function() {
     ...
     */
    MonthCalendar.prototype.getSpecialDates = function(){
    ...
    MonthCalendar.prototype.removeAllDisabledDates = function() {
    ...
    MonthCalendar.prototype.destroyDisabledDates = function() {
     ...
     * @private
     */
    MonthCalendar.prototype.setLocale = function(sLocale){
     ...
     * @private
     */
    MonthCalendar.prototype.getLocale = function(){
     ...
     * @private
     */
    MonthCalendar.prototype._getFocusedDate = function(){
     ...
     * @private
     */
    MonthCalendar.prototype._setFocusedDate = function(oDate){
     ...
     */
    MonthCalendar.prototype.focusDate = function(oDate) {
     ...
     * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
     */
    MonthCalendar.prototype.displayDate = function (oDate) {
     ...
     * @ui5-metamodel This method also will be described in the UI5 (legacy) designtime metamodel
     */
    MonthCalendar.prototype.getStartDate = function(){
     ...
     * @private
     */
    MonthCalendar.prototype.setPopupMode = function(bPoupupMode){
    ...
    MonthCalendar.prototype.setMonths = function(iMonths){
    ...
    MonthCalendar.prototype.setPrimaryCalendarType = function(sCalendarType){
    ...
    MonthCalendar.prototype.setSecondaryCalendarType = function(sCalendarType){
    ...
    MonthCalendar.prototype._getSecondaryCalendarType = function(){
     ...
     */
    MonthCalendar.prototype.setMinDate = function(oDate){
     ...
     * @return {sap.ui.unified.Calendar} <code>this</code> for method chaining
     */
    MonthCalendar.prototype.setMaxDate = function(oDate){
     ...
     * @private
     */
    MonthCalendar.prototype._setMinMaxDateExtend = function(oDate){
     ...
     */
    MonthCalendar.prototype._getLocaleData = function(){
     ...
     */
    MonthCalendar.prototype._getShowMonthHeader = function(){
    ...
    MonthCalendar.prototype.setWidth = function(sWidth){
    ...
    MonthCalendar.prototype.onclick = function(oEvent){
    ...
    MonthCalendar.prototype.onmousedown = function(oEvent){
    ...
    MonthCalendar.prototype.onsapescape = function(oEvent){
    ...
    MonthCalendar.prototype.onsapshow = function(oEvent){
    ...
    MonthCalendar.prototype.onsaphide = MonthCalendar.prototype.onsapshow;

    MonthCalendar.prototype.onsaptabnext = function(oEvent){
    ...
    MonthCalendar.prototype.onsaptabprevious = function(oEvent){
    ...
    MonthCalendar.prototype.onfocusin = function(oEvent){
    ...
    MonthCalendar.prototype.onsapfocusleave = function(oEvent){
    ...
    MonthCalendar.prototype.getFocusDomRef = function(){
    ...
    MonthCalendar.prototype.onThemeChanged = function() {
     ...
     * @private
     */
    MonthCalendar.prototype._updateHeader = function(oDate){
     ...
     * @private
     */
    MonthCalendar.prototype._togglePrevNext = function(oDate, bCheckMonth){
    ...
    MonthCalendar.prototype._togglePrevNexYearPicker = function(){
    ...
    MonthCalendar.prototype._handlePrevious = function(oEvent){
        ...
        switch (this._iMode) {
            case 1: // month picker
                oYearPicker.setYear(oYearPicker.getYear()-1);
    ...
    MonthCalendar.prototype._handleNext = function(oEvent){
     ...
     */
    MonthCalendar.prototype._getDisplayedMonths = function(oDate){
    ...
    MonthCalendar.prototype._getDisplayedSecondaryMonths = function(sPrimaryCalendarType, sSecondaryCalendarType){
    ...
    MonthCalendar.prototype._closedPickers = function(){
    ...
    MonthCalendar.prototype._setDisabledMonths = function(iYear, oMonthPicker) {
     ...
     * @private
     */
    MonthCalendar.prototype._handleFocus = function (oEvent) {
     ...
     * @private
     */
    MonthCalendar.prototype._getVisibleDays = function () {
     ...
     * @private
     */
    MonthCalendar.prototype._focusDate = function (oDate, bOtherMonth, bNoEvent){
    ...
    MonthCalendar.prototype._invalidateMonth = function(oOrigin) {
    ...
    function _handleSelectMonth (oEvent){
        ...
        var oFocusedDate = new CalendarDate(this._getFocusedDate(), this.getPrimaryCalendarType()),
            ...
            iYear = oYearPicker.getYear();


        var oDateRange = new sap.ui.unified.DateRange();
        oDateRange.setStartDate(new Date(iYear, iMonth, 1, 0, 0, 0, 0));

        this.removeAllSelectedDates();
        this.addSelectedDate(oDateRange);

       /* var agreg = this.getAggregation("selectedDates");
        agreg[0] = oDateRange;

        this.setAggregation("selectedDates",agreg);
        ...
        _handleSelect.call(this,oEvent);
