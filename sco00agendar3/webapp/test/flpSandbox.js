		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Agendar",
									"targetURL": "#sapui5agendarsco00agendar3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapui5agendarsco00agendar3-display": {
								"semanticObject": "sapui5agendarsco00agendar3",
								"action": "display",
								"description": "Agendar",
								"title": "Agendar",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sapui5agendar.sco00agendar3",
									"url": sap.ui.require.toUrl("sapui5agendar/sco00agendar3")
								}
							}
						}
					}
