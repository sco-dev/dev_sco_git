		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TimeRecording",
									"targetURL": "#SCOsco00timerecording-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SCOsco00timerecording-display": {
								"semanticObject": "SCOsco00timerecording",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SCO.sco00timerecording",
									"url": sap.ui.require.toUrl("SCO/sco00timerecording")
								}
							}
						}
					}
