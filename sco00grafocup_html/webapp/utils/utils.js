...
sap.ui.define([
    ...
    return {
         ...
         * @param filterBy opcional, objeto para filtrar la tabla de la forma {colIndex: <indice de la columna>, value: <valor a filtrar>}
         */
		openTableDialog: function (model, title, columns, selectionMode, tableParams, filterBy) {
            let that = this;
            ...
            let table = new sap.ui.table.Table(Object.assign(tableParams, {
                rows: '{/' + model + '}',
			...
			if (filterBy) {
				table.filter(table.getColumns()[filterBy.colIndex], filterBy.value);
			}
        ...
        dateToFormat: function (format, d) {
            ...
            let result = this.replaceAll(format, "yyyy", yyyy);
